...
<head>
    ...
    <title>Beranda | Sistem Informasi Peminjaman Aset Kantor Kecamatan Manggar </title>
...
<body>
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="{{ route('login') }}">
                                    ...
                                    <!--img src="{{ asset('/storage/img/logo-pakcamar.png')}}" style="width:200px" height="100px" alt=""-->
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="log_chat_area d-flex align-items-center">
                                <div class="live_chat_btn">
                                    <a class="boxed_btn_orange" href="{{url('about')}}">
                                        ...
                                        <span>Lihat Data Peminjaman Aset </span>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="slider_info">
                            <h3>
                                Sistem Informasi Peminjaman Aset Kantor <br>
                                Kecamatan Manggar</h3>
                            @if (Route::has('login'))
       ...
       <div class="row">
           <div class="col-xl-12">
               <div class="testmonial_text text-center">
                   <h1><b><u>I N F O R M A S I</u></b></h1>
               </div>
           </div>
       </div>
    </div>
    ...
    <div class="mySlides fade">
      ...
      <img src="{{'new/slide4.jpg'}}" style="width:100%">
      
    </div>
    
    <div class="mySlides fade">
      
      <img src="{{'new/slide5.jpg'}}" style="width:100%">
                ...
                <div class="col-xl-12">
                    <div class="section_title text-center mb-100">
                        ...
                        <p>Your domain control panel is designed for ease-of-use and <br> allows for all aspects of your
                            domains.</p-->
                        <a href="{{url('form-peminjaman/create')}}" class="boxed boxed_btn_orange2"><i class="flaticon-user"> Ajukan Peminjaman</i></a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img  src="{{ asset('/storage/img/beltim.png')}}" style="width:100px" height="100px" alt="">
                                </a>
                            </div>
                            <p>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p>
                                Jl. Jendral Sudirman No.66 <br>
                                Kec.Manggar,Kab.Belitung Timur 33512
                                (0719)9225159<br>
                               yumeidasari@gmail.com
                            </p>
                        </div>
                    </div>
                </div>
